...
const SalesForceConsultingService = () => {
  ...
  return (
    <>
      ...
      >
        <div className="w-full h-auto overflow-hidden font-raleway grid grid-cols-1 md:grid-cols-2 relative min-h-screen top-0 sales-force-ConsultingService mb-10 md:mb-10">
          {/* Left Section */}
          <div className="flex flex-col justify-start gap-6 ml-0 md:ml-10 mt-8 md:mt-28">
            ...
            <div className={`flex justify-start md:justify-center ${isMidRange ? "mt-6" : "mt-8 md:mt-4"}`}>
              <button
                type="submit"
        ...
        <div className="min-h-screen mx-auto items-start md:items-center justify-start md:justify-center mt-12 md:mt-0">
          ...
          <div className="space-y-12 md:space-y-0">
            <div className="firstdiv flex flex-col md:flex-row justify-start md:justify-between items-start md:items-center mt-8 gap-6 md:gap-8 mb-12 md:mb-10">
              <div className="text-left max-w-[90%] md:max-w-[920px] max-h-[190px] p-[10px] gap-[10px] ml-0 md:ml-8">
              ...
              <div className="flex justify-center items-start mr-0 md:mr-10 mt-8 md:mt-0 w-full">
                <img
                  src={daimg}
            ...
            <div className="seconddiv flex flex-col md:flex-row justify-start md:justify-between items-start md:items-center mt-8 gap-6 md:gap-8 mb-12 md:mb-10">
              <div className="text-left max-w-[90%] md:max-w-[920px] max-h-[190px] p-[10px] gap-[10px] md:order-2">
                ...
                <p className="font-raleway font-medium p-[10px] text-[14px] md:text-[18px] text-left md:text-justify mr-0 md:mr-10 leading-[20px] md:leading-[24.59px] tracking-[0.1em] mt-4 md:mt-8">
              ...
              <div className="flex justify-center items-start md:order-1 ml-0 md:ml-10 mt-8 md:mt-0 w-full">
                <img
                  src={solutionDesign}
                  alt="Solution Design"
                  className="max-w-[220px] md:max-w-[300px] max-h-[200px] md:max-h-[298.39px] object-contain"
            ...
            <div className="pt-12 md:pt-20 mb-12 md:mb-10">
              <h6 className="font-bold text-[20px] md:text-[30px] leading-[30px] md:leading-[45.49px] tracking-[0.1em] text-left md:text-center">
                Best Practice We Follow
              </h6>
              <div className="flex justify-start md:justify-center items-start md:items-center mt-2 md:mt-0.5">
                <hr
                  className="w-[200px] md:w-[400px] h-[1px] border-none"
                  style={{
                    backgroundImage: isDarkTheme
                      ? "linear-gradient(to right, #9CFF00, #00D1FF)"
                      : "linear-gradient(to right, #000000, #1F4B55)",
            ...
            <div className="thirddiv flex flex-col md:flex-row justify-start md:justify-between items-start md:items-center mt-6 md:mt-8 gap-6 md:gap-8 mb-12 md:mb-10 ">
              <div className="text-left max-w-[90%] md:max-w-[900px] max-h-[190px] p-[10px] gap-[10px] ml-0 md:ml-8">
