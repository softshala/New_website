...
const ServiceNow = () => {
    ...
    return (
        <div
            className={`w-full max-w-[1055px] mx-auto p-4 md:p-0 md:w-[1055px] h-auto md:h-[544.81px] gap-5 relative mt-8 flex flex-col items-center ${isMobile ? "justify-center" : "md:items-start"
                }`}
        ...
        >
            <img
                ...
                alt="ServiceNow"
                className={`w-full md:w-auto max-w-[400px] mr-9 md:mr-0 md:max-w-none service-img ${isMobile ? "relative -mt-16" : "absolute z-20"
                    }`}
            />
            <h1
                ref={headingRef}
